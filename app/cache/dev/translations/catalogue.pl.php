...
',
  ...
  array (
    ...
    'views.index.filters' => 'Filtry',
    'views.index.filter' => 'Filtr',
    'views.index.reset' => 'Reset',
    'views.index.list' => '%entity% - lista',
    'views.index.actions' => 'Akcje',
    'views.index.createnew' => 'Utwórz',
    'views.index.pagprev' => '&larr; Poprzednia',
    'views.index.pagnext' => 'Następna &rarr;',
    'views.actions.show' => 'podgląd',
    'views.actions.edit' => 'edycja',
    'views.recordactions.backtothelist' => 'Wróć do listy',
    'views.recordactions.edit' => 'Edycja',
    'views.recordactions.delete' => 'Usuń',
    'views.recordactions.confirm' => 'Usunąć element?',
    'views.new.creation' => 'Utwórz %entity%',
    'views.new.create' => 'Utwórz',
    'views.edit.edit' => 'Edytuj %entity%',
    'views.edit.editbutton' => 'Edytuj',
    'views.show.show' => 'Lista %entity%',
    'flash.create.success' => 'Element utworzony prawidłowo.',
    'flash.create.error' => 'Tworzenie nowego elementu zakończone błędem.',
    'flash.update.success' => 'Aktualizacja powidoła się.',
    'flash.update.error' => 'Aktualizacja zakończona błędem.',
    'flash.delete.success' => 'Element został usunięty.',
    'flash.delete.error' => 'Próba usunięcia zakończona błędem.',
  ),
));
